...
# python_cmd (array) and python_exec are provided by setup_isaac_runtime.sh, sourced after
# argument parsing so the dependency install runs only once arguments are validated.
