...
| `deck.yaml` | ✅ | **Generated** combined slide source, keyed by stable `id` (title slug). Tracked so PR diffs are clean — inserting a slide mid-deck is one added block, no renumbering. Do not hand-edit; regenerated by `gen_content.py`. |
