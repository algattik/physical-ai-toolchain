...
6. **Appendix (~19):** 6 tool primers + glossary · production-contracts · disk-matrix · small-refactor · reviewer-cost detail · smoke operating-cost + fail-safe · anticipated objections (incl. pin-Python) · economics/ROI · Renovate adoption + spike config · alternatives · mandate & method.
